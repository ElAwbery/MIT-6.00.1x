...
the correct solution because I didn't realise that my representation of a math sum was wrong.
'''
...
while abs (balance - monthlyGuess*12) > epsilon:
    ...
    if abs (balance - monthlyGuess*12) < epsilon:                           #the order of this if clause is wrong and break unecessary. 
